<template>
  <div class="page-info">
    ...
    <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="daymoney" label="日均销售额" show-overflow-tooltip>
      </el-table-column>
...
<script>
  import { xiaoBorderAPI} from '../../api/api';
  export default {
    created(){
      this.dataLoad();
    },
    ...
    methods: {
      dataLoad(){
        xiaoBorderAPI({pageSize:this.page.pageSize,pageIndex:this.page.currentPage}).then((res)=>{
          console.log(res)
